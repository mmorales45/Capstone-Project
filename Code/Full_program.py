'''
This function creates configurations for the youBot based on combining TrajectoryGenerator, NextState and Feedbackcontrols. Currently this results in the Overshoot results.
To play this file, run the following,

python3 Full_program.py
...
def Full_program():
    ...
    initial_configuration = np.array([chasis_phi,chasis_x,chasis_y,joint_1,joint_2,joint_3,joint_4,joint_5,wheel_1,wheel_2,wheel_3,wheel_4,gripper_state]) #Good connfig kp=5,ki=1,speed=10  
    ...
    plt.title(f"NewTask, Kp value:{kp_multiplier},Ki value:{ki_multiplier}")  
    plt.legend()
    plt.show()
    

if __name__ == "__main__": # the main function
    logging.info('python3 Full_program.py')
